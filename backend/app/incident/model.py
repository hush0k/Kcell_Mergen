...
from app.incident.enums import ConfirmedFraud, IncidentStatus
...
class Incident(Base, TimeStampMixin):
    ...
    estimated_loss: Mapped[Decimal | None] = mapped_column(
        Numeric(15, 2), nullable=True
    )
    opportunity_loss: Mapped[Decimal | None] = mapped_column(
        Numeric(15, 2), nullable=True
    )
    bad_debt: Mapped[Decimal | None] = mapped_column(Numeric(15, 2), nullable=True)
    prevented_savings: Mapped[Decimal | None] = mapped_column(
        Numeric(15, 2), nullable=True
    )
    recovered_savings: Mapped[Decimal | None] = mapped_column(
        Numeric(15, 2), nullable=True
    )
    ...
    kpi_calculation: Mapped[Decimal | None] = mapped_column(
        Numeric(15, 2), nullable=True
    )
    confirmed_fraud: Mapped[ConfirmedFraud | None] = mapped_column(
        Enum(
            ConfirmedFraud,
            schema=settings.POSTGRES_SCHEMA,
