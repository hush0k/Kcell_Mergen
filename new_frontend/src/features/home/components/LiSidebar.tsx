...
export function LiSidebar({ name, icon, isOpen, onClick, collapsed, statistics }: Info) {
    return (
        <button
        ...
        >
            ...
            <div className="relative w-16 flex items-center justify-center shrink-0 text-mg-text-2">
                {icon}
            ...
            <span className={`flex-1 flex items-center justify-between transition-all duration-300 overflow-hidden whitespace-nowrap text-mg-text-2 font-medium text-base text-left ${
