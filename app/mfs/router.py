...
from app.mfs.shcemas import MfsAuditResponse, MfsAuditCreate, MfsActionResponse, MfsActionRequest
...
def get_audit_service(db: Annotated[AsyncSession, Depends(get_db)]) -> MfsAuditLogService:
    return MfsAuditLogService(db)
